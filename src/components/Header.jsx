...
const Header = () => {
    ...
    return (
    <header className="flex items-center justify-between bg-white border-b p-9 h-9109">
        <div className="flex items-center justify-center w-24 px-3 py-1 text-xl font-bold bg-gray-200 h-14 text-orange">
        Logo
        </div>
        <nav className="items-center hidden p-2 px-3 space-x-8 bg-white border rounded-full h-974 border-slate-300 md:flex">
        {/* jobs */}
        <a
            href="#"
            className={`h-958 w-9109 text-lg flex items-center gap-2 px-3 font-medium rounded-full transition-all duration-300 ease-in-out ${
            activeLink === "jobs"
                ? "text-white bg-orange border-2 border-red-300"
        ...
        >
            ...
            <path
                ...
                stroke={activeLink === "jobs" ? "white" : "#B0B0B0"}
                strokeWidth="2"
                strokeLinecap="round"
        ...
        <a
            href="#"
            className={`h-958 flex text-lg items-center gap-2 px-3 font-medium rounded-full transition-all duration-300 ease-in-out ${
            activeLink === "messages"
                ? "text-white bg-orange border-2 border-red-300"
                : "text-gray-400 bg-white"
            }`}
        ...
        >
            ...
            <path
                ...
                stroke={activeLink === "messages" ? "white" : "#B0B0B0"}
                strokeWidth="2"
                strokeLinecap="round"
                strokeLinejoin="round"
            />
        ...
        >
            ...
            <path
                ...
                stroke={activeLink === "payments" ? "white" : "#B0B0B0"}
                strokeWidth="2"
                strokeLinecap="round"
                strokeLinejoin="round"
            />
        ...
        <div
            ref={mobileMenuRef}
            className={`fixed inset-y-0 right-0 z-30 w-2/3 h-full bg-white shadow-lg md:hidden transition-transform duration-300 ease-in-out ${
        ...
        >
            ...
            <nav className="flex-grow space-y-6">
                {["jobs", "messages", "payments"].map((link) => (
                <a
                    key={link}
                    href="#"
                    className={`text-lg flex items-center gap-3 px-4 py-2 font-medium rounded-full transition-all duration-300 ease-in-out ${
                    activeLink === link
                ...
                >
                    ...
                    <path
                        d="M8 21.5V7.5C8 6.57003 8 6.10504 8.10222 5.72354C8.37962 4.68827 9.18827 3.87962 10.2235 3.60222C10.605 3.5 11.07 3.5 12 3.5C12.93 3.5 13.395 3.5 13.7765 3.60222C14.8117 3.87962 15.6204 4.68827 15.8978 5.72354C16 6.10504 16 6.57003 16 7.5V21.5M5.2 21.5H18.8C19.9201 21.5 20.4802 21.5 20.908 21.282C21.2843 21.0903 21.5903 20.7843 21.782 20.408C22 19.9802 22 19.4201 22 18.3V10.7C22 9.57989 22 9.01984 21.782 8.59202C21.5903 8.21569 21.2843 7.90973 20.908 7.71799C20.4802 7.5 19.9201 7.5 18.8 7.5H5.2C4.07989 7.5 3.51984 7.5 3.09202 7.71799C2.71569 7.90973 2.40973 8.21569 2.21799 8.59202C2 9.01984 2 9.57989 2 10.7V18.3C2 19.4201 2 19.9802 2.21799 20.408C2.40973 20.7843 2.71569 21.0903 3.09202 21.282C3.51984 21.5 4.0799 21.5 5.2 21.5Z"
                        stroke={activeLink === link ? "#FF6600" : "#B0B0B0"}
                        strokeWidth="2"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                    />
        ...
        <button
            ...
            navIsOpen ? "translate-x-0" : "-translate-x-0"
            } md:hidden bg-white border border-gray-200 rounded-l-full p-2 z-40 transition-transform duration-300 ease-in-out`}
        >
            {navIsOpen ? <ChevronRight size={24} /> : <ChevronLeft size={24} />}
        </button>

        <div
            className={`fixed inset-0 bg-black transition-opacity duration-300 ease-in-out ${
            navIsOpen ? "opacity-50 z-20" : "opacity-0 pointer-events-none"
            }`}
            onClick={handleNav}
        />
        </div>
